...
class MyPanel(wx.Panel): 
    ...
    def __init__(self, parent, id , mysize): 
        ...
        if server == True :
            commThread = threading.Thread(target=comm.server_recv, args=("server","client"))
        else:
            #commThread = threading.Thread(target=comm.client_send, args=("client","server"))
            commThread = threading.Thread(target=comm.server_recv, args=("client","server"))
        commThread.start()
